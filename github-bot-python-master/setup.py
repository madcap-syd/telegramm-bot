...
#
# However, when we do this, we also import `github_bot/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'github_bot_cli = github_bot.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'github_bot_gui = github_bot.gui:entry_point'
        # ]
    }
)
